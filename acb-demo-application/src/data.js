...
export const trapSpecificData = {
  ...
  trapSequence: [
    { time: '17:25 hrs', text: 'Trap party positioned discreetly around the Panchayat Raj office. Complainant proceeded to the AO chamber with the tainted amount.', dot: '#16A34A', line: 1 },
    ...
    { time: '17:42 hrs', text: 'Trap party rushed in, identified themselves and secured the AO. AO right-hand fingers dipped in fresh sodium carbonate solution — turned pink.', dot: '#16A34A', line: 1 },
    { time: '17:55 hrs', text: 'Tainted notes recovered from AO right hip pocket; serial numbers tallied with Mediators Report-I. Official file and shirt seized.', dot: '#16A34A', line: 1 },
    { time: '18:05 hrs', text: 'AO spontaneous explanation recorded; formal arrest effected in the presence of both mediators.', dot: '#16A34A', line: 0 },
  ],
};
...
export const STATE_DISTRICTS = {
  'Telangana': ['Adilabad', 'Bhadradri Kothagudem', 'Hyderabad', 'Jagtial', 'Jangaon', 'Kamareddy', 'Karimnagar', 'Khammam', 'Kumuram Bheem', 'Mahabubabad', 'Mahbubnagar', 'Mancherial', 'Medak', 'Medchal-Malkajgiri', 'Mulugu', 'Nalgonda', 'Narayanpet', 'Nirmal', 'Nizamabad', 'Peddapalli', 'Rajanna Sircilla', 'Ranga Reddy', 'Sangareddy', 'Siddipet', 'Suryapet', 'Vikarabad', 'Wanaparthy', 'Warangal Rural', 'Warangal Urban', 'Yadadri Bhuvanagiri'],
  'Andhra Pradesh': ['Anantapur', 'Chittoor', 'East Godavari', 'Guntur', 'Kadapa', 'Krishna', 'Kurnool', 'Nellore', 'Prakasam', 'Srikakulam', 'Visakhapatnam', 'Vizianagaram', 'West Godavari'],
  'Maharashtra': ['Ahmednagar', 'Akola', 'Amravati', 'Aurangabad', 'Beed', 'Bhandara', 'Buldhana', 'Chandrapur', 'Dhule', 'Dombivali', 'Gadchiroli', 'Goa', 'Gondia', 'Greater Mumbai', 'Hingoli', 'Jalgaon', 'Jalna', 'Kolhapur', 'Latur', 'Malvan', 'Malegaon', 'Nashik', 'Nanded', 'Nagpur', 'Navi Mumbai', 'Osmānābād', 'Panvel', 'Parbhani', 'Pimpri-Chinchwad', 'Pune', 'Raigarh', 'Raigad', 'Raipur', 'Rajahmundry', 'Rajkot', 'Ramtek', 'Rangareddy', 'Ratlam', 'Ratnagiri', 'Raver', 'Sangli', 'Satara', 'Satna', 'Sawantwadi', 'Shahada', 'Shahdol', 'Sharjah', 'Shrigonda'],
  'Karnataka': ['Bagalkot', 'Ballari', 'Belagavi', 'Bengaluru', 'Bengaluru Rural', 'Bidar', 'Bijapura', 'Chamarajanagar', 'Chikballapur', 'Chikmagalur', 'Chitradurga', 'Dakshina Kannada', 'Davanagere', 'Dharwad', 'Gadag', 'Gulbarga', 'Hassan', 'Haveri', 'Kalaburagi', 'Kodagu', 'Kolar', 'Koppal', 'Mandya', 'Mangaluru', 'Mysuru', 'Raichur', 'Shivamogga', 'Tumkur', 'Udupi', 'Uttara Kannada', 'Yadgir'],
  'Tamil Nadu': ['Ariyalur', 'Chengalpattu', 'Chennai', 'Coimbatore', 'Cuddalore', 'Dharmapuri', 'Dindigul', 'Erode', 'Kallakurichi', 'Kancheepuram', 'Kanyakumari', 'Karaikudi', 'Krishnagiri', 'Madurai', 'Mayiladuthurai', 'Nagapattinam', 'Namakkal', 'Nilgiris', 'Perambalur', 'Puducherry', 'Ramanathapuram', 'Ranipet', 'Salem', 'Sivaganga', 'Tenkasi', 'Thanjavur', 'Theni', 'Thoothukudi', 'Tiruchirapalli', 'Tirunelveli', 'Tirupathur', 'Tiruppur', 'Tiruvannamalai', 'Tiruvarur', 'Vellore', 'Villupuram', 'Virudhunagar'],
...
// Government Departments and Central Ministries
