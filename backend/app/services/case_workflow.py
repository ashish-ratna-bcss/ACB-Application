...
def get_workflow(db: Session, case: Case, *, view_phase: str | None = None) -> dict[str, Any]:
    ...
    return {
        ...
        "accused": case.accused_name or "—",
        "designation": case.accused_designation or "",
        "department": case.accused_department or "—",
        "location": case.location or "—",
        "priority": case.priority or "medium",
        "amount": case.amount_involved or 0,
        "dspName": case.dsp_name,
