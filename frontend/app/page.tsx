...
import { Shield, Eye, EyeOff, Lock, User, ChevronRight, Cpu } from 'lucide-react';

const DEMO_CREDENTIALS = [
  { email: 'officer@acb.gov.in', password: 'acb@2024', role: 'Investigation Officer' },
    ...
    <div className="min-h-screen flex">
      ...
      <div className="login-gradient flex-1 hidden lg:flex flex-col justify-between p-12 relative overflow-hidden">
        ...
        <div
          ...
          style={{ background: 'radial-gradient(circle, #06B6D4, transparent)', animation: 'float 7s ease-in-out infinite' }}
        />
        <div
          className="absolute bottom-1/3 left-1/4 w-48 h-48 rounded-full opacity-15"
          style={{ background: 'radial-gradient(circle, #3B82F6, transparent)', animation: 'float 5s ease-in-out infinite reverse' }}
        />

        {/* Logo */}
        <div className="relative z-10 animate-fade-in">
          <div className="flex items-center gap-3 mb-2">
            <div className="w-12 h-12 rounded-xl flex items-center justify-center" style={{ background: 'linear-gradient(135deg, #06B6D4, #2563EB)' }}>
        ...
        <div className="relative z-10 animate-slide-up" style={{ animationDelay: '0.2s' }}>
          ...
          <div className="mb-8">
            ...
            <h1 className="text-4xl font-bold text-white leading-tight mb-4">
              ...
              <br />
              <span className="text-cyan-400">Documentation Platform</span>
            </h1>
            <p className="text-slate-400 text-lg leading-relaxed max-w-md">
              Automate investigation workflows with AI-powered document extraction, intelligent draft generation, and seamless case management.
            </p>
          </div>
      ...
      <div className="w-full lg:w-[480px] flex items-center justify-center p-8 bg-slate-50">
        <div className="w-full max-w-sm animate-slide-in-right">
          ...
          <div className="lg:hidden flex items-center gap-3 mb-8">
            <div className="w-10 h-10 rounded-xl flex items-center justify-center" style={{ background: 'linear-gradient(135deg, #06B6D4, #2563EB)' }}>
              <Shield size={20} className="text-white" />
            </div>
            <div>
              <div className="font-bold text-navy-900 text-base">Anti-Corruption Bureau</div>
              <div className="text-slate-500 text-xs">Government of Telangana</div>
            </div>
          </div>

          <div className="mb-8">
            <h2 className="text-2xl font-bold text-slate-800 mb-2">Welcome back</h2>
            <p className="text-slate-500 text-sm">Sign in to the investigation platform</p>
          </div>

          {/* Demo credentials */}
          <div className="mb-6 p-4 rounded-xl border border-blue-100 bg-blue-50">
            <p className="text-xs font-600 text-blue-700 mb-3 font-semibold uppercase tracking-wide">Demo Access</p>
              ...
              {DEMO_CREDENTIALS.map((cred) => (
                ...
                >
                  <div className="text-left">
                    <div className="font-semibold text-slate-700">{cred.role}</div>
